...
PRIVATE_LOCAL_CFLAGS := -O2 -g -W -Wall		\
			...
			-DPF_CAN=29		\
			-DAF_CAN=PF_CAN \
			-Wno-sign-compare -Wno-unused-parameter -Wno-pointer-arith -Wno-address-of-packed-member -Wno-absolute-value\
#
# canlib
#
...
ifneq ( ,$(filter 13 T U 14 UpsideDownCake V VanillaIceCream 15 W Baklava 16,$(PLATFORM_VERSION)))
...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/include/
LOCAL_CFLAGS := $(PRIVATE_LOCAL_CFLAGS)
ifneq ( ,$(filter 13 T U 14 UpsideDownCake V VanillaIceCream 15,$(PLATFORM_VERSION)))
LOCAL_VENDOR_MODULE := true
endif
